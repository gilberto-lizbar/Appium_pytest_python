...
desired_caps = dict(
    ...
    platformVersion='13',
    app='/Users/gilberto.barraza/Desktop/Repo_Cursos/Courses_Resources/'
        'Appium_Selenium_Python/AppiumPython/app/Android/Android.SauceLabs.Mobile.Sample.app.2.7.1.apk',
