...
driver.find_element(By.XPATH, "//*[@text='Lists']").click()
driver.find_element(By.XPATH, "//*[@text='01. Array']").click()

# By adding .setMaxSearchSwipes(3) scroll will have limit even if the text is not displayed yet
ui_scrollable1 = ('new UiScrollable(new UiSelector().scrollable(true)).setAsVerticalList()'
                  '.setMaxSearchSwipes(3).scrollIntoView(new UiSelector().text("Curd"))')

#  #By Default scroll is set as vertical it is not necessary to define as .setAsVerticalList()
