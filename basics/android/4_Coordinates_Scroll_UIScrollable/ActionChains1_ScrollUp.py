...
# WebDriverWait(driver,30).until(expected_conditions.presence_of_element_located(By.XPATH,"desiredObject"))
# WebDriverWait(driver,30, poll_frequency=3).until(expected_conditions.presence_of_element_located(By.XPATH,"desiredObject"))
