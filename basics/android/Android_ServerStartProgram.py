...
driver.find_element(By.XPATH,'//android.widget.EditText[@content-desc="input-email"]').send_keys("gilberto.lizbar@gmail.com")
driver.find_element(By.XPATH,'//android.widget.EditText[@content-desc="input-password"]').send_keys("NewPass#123")
driver.find_element(By.XPATH,'//android.widget.EditText[@content-desc="input-repeat-password"]').send_keys("NewPass#123")
