...
def setup_function(request):
    ...
    video_path = ("/Users/gilberto.barraza/Desktop/Repo_Cursos/Appium_Python/"
                  "pyTestScenarios/screen_and_records/iOSNativeVideo.mp4")
    ...
    if hasattr(item, 'rep_call') and item.rep_call.failed:
        ...
        if recording_process:
            ...
            if os.path.exists(video_path):
                ...
                #allure.attach(base64.b64decode(video_path), name="failure_video", attachment_type=AttachmentType.MP4)
                with open(video_path, 'rb') as video_file:
                    allure.attach(video_file.read(), name="failure_video", attachment_type=AttachmentType.MP4)
                print("Test failed: Screenshot and Video attached to report.")
            else:
                print("Video does not exist or was not created")
        else:
            print("Record process was not started")
    # ****log_on_failure****>>
