...
def test_soft_assertion(setup, before_Each_function):
    ...
    try:
        ...
        soft_assert.check("Alert" in text, f"Expected 'Alert Views' to be) in text, got: '{text}'")
...
def test_no_soft_assertion(setup, before_Each_function):
    print("No assertion Test executed")
